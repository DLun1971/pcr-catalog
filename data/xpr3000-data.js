// xpr3000-data.js — XPR 3000 Series accessory data (PDF-verified: Professional Tier Accessory Catalog)
// Covers: XPR 3000, XPR 3000e (3000e-exclusive items noted in description)
...
const XPR3000_CATEGORIES = [
    ...
    items: [
      {
        ...
        part: 'PMNN4491',
        impres: true, chem: 'Li-Ion', capacity_mah: 2100,
        dims_mm: '113 x 52 x 18', weight_g: 130,
        hazloc: null, ip: 'IP68', op_temp: '-10\u00b0C to +60\u00b0C'
      },
      {
        desc: 'IMPRES Li-Ion 2450mAh IP68 Battery',
        part: 'PMNN4544',
        impres: true, chem: 'Li-Ion', capacity_mah: 2450,
        dims_mm: '113 x 52 x 23', weight_g: 150,
        hazloc: null, ip: 'IP68', op_temp: '-20\u00b0C to +60\u00b0C'
      },
      {
        desc: 'IMPRES Li-Ion 3000mAh IP68 Battery',
        part: 'PMNN4493',
        impres: true, chem: 'Li-Ion', capacity_mah: 3000,
        dims_mm: '113 x 52 x 23', weight_g: 155,
        hazloc: null, ip: 'IP68', op_temp: '-10\u00b0C to +60\u00b0C'
      },
      {
      ...
      },
      {
        ...
        part: 'PMNN4490',
        impres: true, chem: 'Li-Ion', capacity_mah: 2900,
        dims_mm: '113 x 52 x 23', weight_g: 210,
        hazloc: 'UL', ip: 'IP68', op_temp: '-10\u00b0C to +60\u00b0C'
      },
      {
        desc: 'IMPRES Li-Ion 2500mAh IP68 TIA4950 Battery (XPR 3000e only)',
        part: 'NNTN8560',
        impres: true, chem: 'Li-Ion', capacity_mah: 2500,
        dims_mm: '113 x 52 x 23', weight_g: 210,
        hazloc: 'UL', ip: 'IP68', op_temp: '-10\u00b0C to +60\u00b0C'
      },
      {
        desc: 'IMPRES Li-Ion 2900mAh IP68 TIA4950 Battery (XPR 3000e only)',
        part: 'PMNN4489',
        impres: true, chem: 'Li-Ion', capacity_mah: 2900,
        dims_mm: '113 x 52 x 23', weight_g: 210,
        hazloc: 'UL', ip: 'IP68', op_temp: '-10\u00b0C to +60\u00b0C'
  ...
  // ── CATEGORY 2: CHARGERS ───────────────────────────────────────────────────
  {
    ...
    items: [
      // Single-unit non-IMPRES
      { desc: 'Single-Unit Rapid Rate Charger, CHN Plug', part: 'NNTN8224', impres: false, chem: 'Li-Ion, NiMh', pwr_src: '240 VAC', dims_mm: '61 x 97 x 163', pockets: 1 },
      { desc: 'Single-Unit Rapid Rate Charger, ARG Plug', part: 'NNTN8225', impres: false, chem: 'Li-Ion, NiMh', pwr_src: null, dims_mm: '61 x 97 x 163', pockets: 1 },
      { desc: 'Single-Unit Rapid Rate Charger, Switch-Mode 21W, BZL Plug', part: 'NNTN8280', impres: false, chem: 'Li-Ion, NiMh', pwr_src: '100-240 VAC', dims_mm: '61 x 97 x 163', pockets: 1 },
      { desc: 'Single-Unit Rapid Rate Charger, EURO Plug', part: 'NNTN8292', impres: false, chem: 'Li-Ion, NiMh', pwr_src: '240 VAC', dims_mm: '61 x 97 x 163', pockets: 1 },
      { desc: 'Single-Unit Rapid Rate Charger, UK Plug', part: 'NNTN8293', impres: false, chem: 'Li-Ion, NiMh', pwr_src: '240 VAC', dims_mm: '61 x 97 x 163', pockets: 1 },
      // IMPRES single-unit
      { desc: 'IMPRES Single-Unit Charger, US Plug', part: 'PMPN4576A', impres: true, chem: 'Li-Ion, NiMh', pwr_src: '120 VAC', dims_mm: '51 x 88 x 94', pockets: 1 },
      ...
      { desc: 'Travel Charger, Rapid Rate with Voltage Regulated Adapter', part: 'NNTN8525', impres: false, chem: 'Li-Ion, NiMh', pwr_src: '12 VDC cigarette lighter', dims_mm: '58 x 64 x 67', pockets: 1 }
    ]
  },
    ...
    items: [
      {
        ...
        noise_type: 'Noise-canceling', full_duplex: false,
        vol_ctrl: null, prog_btn: null, audio_jack: true,
        ip: 'IP54', hazloc: 'UL', dims_mm: '60 x 78 x 28'
      },
      {
        desc: 'IMPRES Windporting Remote Speaker Microphone, Small (IP55)',
        part: 'PMMN4073',
        impres: true, intel_audio: false, ai_noise: false,
        noise_type: 'Windporting', full_duplex: false,
        vol_ctrl: null, prog_btn: null, audio_jack: true,
        ip: 'IP55', hazloc: 'UL', dims_mm: '55 x 60 x 27'
      },
      {
        ...
        noise_type: 'Windporting', full_duplex: false,
        vol_ctrl: null, prog_btn: null, audio_jack: true,
        ip: 'IP57', hazloc: 'UL', dims_mm: '55 x 60 x 27'
      },
      {
        ...
        noise_type: 'Windporting', full_duplex: false,
        vol_ctrl: null, prog_btn: null, audio_jack: true,
        ip: 'IP54', hazloc: 'UL', dims_mm: '55 x 60 x 27'
      },
      {
        ...
        impres: false, intel_audio: false, ai_noise: false,
        noise_type: 'Windporting', full_duplex: false,
        vol_ctrl: 'High/Low', prog_btn: null, audio_jack: false,
        ip: 'IP67', hazloc: null, dims_mm: '60 x 78 x 28'
      },
      {
        ...
        impres: false, intel_audio: false, ai_noise: false,
        noise_type: 'Windporting', full_duplex: false,
        vol_ctrl: null, prog_btn: null, audio_jack: false,
        ip: 'IP67', hazloc: null, dims_mm: '58 x 84 x 24'
      }
    ]
  },
  ...
  // ── CATEGORY 4: SURVEILLANCE / EARPIECES ──────────────────────────────────
  {
    ...
    items: [
      ...
      // Mag One earpieces
      { desc: 'Mag One Earbud with In-Line Microphone and PTT', part: 'PMLN6069', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Earbud', mic_type: 'In-line', full_duplex: false, hazloc: null },
      { desc: 'Mag One Flexible Earpiece with In-Line Microphone and PTT', part: 'PMLN5973', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Over-the-ear', mic_type: 'In-line', full_duplex: false, hazloc: null },
      { desc: 'Mag One Swivel Earpiece with In-Line Microphone and PTT', part: 'PMLN5975', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Over-the-ear', mic_type: 'In-line', full_duplex: false, hazloc: null },
      { desc: 'Mag One Earset with Boom Microphone and In-Line PTT', part: 'PMLN5976', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Earset', mic_type: 'Boom', full_duplex: false, hazloc: null },
      { desc: 'Mag One Earbud with In-Line Microphone and PTT, Black', part: 'PMLN7156', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Earbud', mic_type: 'In-line', full_duplex: false, hazloc: null },
      { desc: 'Adjustable D-Style Earpiece with In-Line Microphone and PTT, Black', part: 'PMLN6757', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Adjustable D-Style', mic_type: 'In-line', full_duplex: false, hazloc: null },
      { desc: 'Adjustable D-Style Earpiece with In-Line Microphone and PTT, Black', part: 'PMLN7159', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Adjustable D-Style', mic_type: 'In-line', full_duplex: false, hazloc: null },
      { desc: 'Swivel Earpiece with In-Line Microphone and PTT', part: 'PMLN7189', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Over-the-ear', mic_type: 'In-line', full_duplex: false, hazloc: null },
  ...
  // ── CATEGORY 6: CARRY ─────────────────────────────────────────────────────
  {
    ...
    items: [
      { desc: 'Hard Leather Case with 2.5" Swivel Belt Loop (Non-Display, ATEX)', part: 'PMLN6096', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: false, d_rings: true },
      { desc: 'Hard Leather Case with 2.5" Swivel Belt Loop (Display, ATEX)', part: 'PMLN6097', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: true, d_rings: true },
      { desc: 'Soft Leather Case with 2.5" Swivel Belt Loop (Non-Display, ATEX)', part: 'PMLN6098', material: 'Soft leather', belt_sz: 2.5, swivel: true, display: false, d_rings: true },
      { desc: 'Soft Leather Case with 2.5" Swivel Belt Loop (Display, ATEX)', part: 'PMLN6099', material: 'Soft leather', belt_sz: 2.5, swivel: true, display: true, d_rings: true },
      { desc: 'Synthetic Leather Case with 3" Fixed Belt Loop (Standard Battery)', part: 'PMLN7536', material: 'Synthetic leather', belt_sz: 3, swivel: false, display: null, d_rings: true },
      { desc: 'Synthetic Leather Case with 3" Fixed Belt Loop (High Capacity Battery)', part: 'PMLN7537', material: 'Synthetic leather', belt_sz: 3, swivel: false, display: null, d_rings: true },
      { desc: 'Nylon Case with 3" Fixed Belt Loop (Limited Keypad Display)', part: 'PMLN5869', material: 'Nylon', belt_sz: 3, swivel: false, display: true, d_rings: true },
      { desc: 'Hard Leather Case with 2.5" Swivel Belt Loop (Limited Keypad Display)', part: 'PMLN5867', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: true, d_rings: true },
      { desc: 'Hard Leather Case with 3" Swivel Belt Loop (Limited Keypad Display)', part: 'PMLN5865', material: 'Hard leather', belt_sz: 3, swivel: true, display: true, d_rings: true },
      { desc: 'Hard Leather Case with 3" Fixed Belt Loop (Limited Keypad Display)', part: 'PMLN5863', material: 'Hard leather', belt_sz: 3, swivel: false, display: true, d_rings: true },
      { desc: 'Soft Leather Case with 2.5" Swivel Belt Loop (Display)', part: 'PMLN5016', material: 'Soft leather', belt_sz: 2.5, swivel: true, display: true, d_rings: true },
      { desc: 'Soft Leather Case with 3" Swivel Belt Loop (Display)', part: 'PMLN5017', material: 'Soft leather', belt_sz: 3, swivel: true, display: true, d_rings: true },
      { desc: 'Soft Leather Case with 3" Fixed Belt Loop (Display)', part: 'PMLN5018', material: 'Soft leather', belt_sz: 3, swivel: false, display: true, d_rings: true },
      { desc: 'Nylon Case with 3" Fixed Belt Loop (Non-Display)', part: 'PMLN5870', material: 'Nylon', belt_sz: 3, swivel: false, display: false, d_rings: true },
      { desc: 'Hard Leather Case with 2.5" Swivel Belt Loop (Non-Display)', part: 'PMLN5868', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: false, d_rings: true },
      { desc: 'Hard Leather Case with 3" Swivel Belt Loop (Non-Display)', part: 'PMLN5866', material: 'Hard leather', belt_sz: 3, swivel: true, display: false, d_rings: true },
      { desc: 'Hard Leather Case with 3" Fixed Belt Loop (Non-Display)', part: 'PMLN5864', material: 'Hard leather', belt_sz: 3, swivel: false, display: false, d_rings: true },
      { desc: 'Soft Leather Case with 2.5" Swivel Belt Loop (Non-Display)', part: 'PMLN5025', material: 'Soft leather', belt_sz: 2.5, swivel: true, display: false, d_rings: true },
      { desc: 'Soft Leather Case with 3" Swivel Belt Loop (Non-Display)', part: 'PMLN5026', material: 'Soft leather', belt_sz: 3, swivel: true, display: false, d_rings: true },
      { desc: 'Soft Leather Case with 3" Fixed Belt Loop (Non-Display)', part: 'PMLN5027', material: 'Soft leather', belt_sz: 3, swivel: false, display: false, d_rings: true },
      { desc: 'Nylon Case with 3" Fixed Belt Loop (Display)', part: 'PMLN5015', material: 'Nylon', belt_sz: 3, swivel: false, display: true, d_rings: true },
      { desc: 'Hard Leather Case with 2.5" Swivel Belt Loop (Display)', part: 'PMLN5019', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: true, d_rings: true },
      // Belt clips
      { desc: 'Silent Alert Belt Clip (for use with PMNN4488)', part: 'PMLN7296', material: 'Plastic', belt_sz: null, swivel: false, display: null, d_rings: false },
  ...
  // ── CATEGORY 8: CABLES ────────────────────────────────────────────────────
  {
    ...
    items: [
      { desc: 'Programming Cable Slim Conn to DB25 and TTR', part: 'PMKN4116' },
  ...
  // ── CATEGORY 9: SCREEN PROTECTORS ────────────────────────────────────────
  {
    ...
    cols: ['Description','Part Number'],
    items: [
      { desc: 'Accessory Connector Dust Cover', part: '15012157001' },
      { desc: 'Accessory Connector Dust Cover', part: '1571477L01' },
      { desc: 'Accessory Connector Dust Cover', part: 'PMLN6066' }
    ]
  },
  ...
  // ── CATEGORY 12: BLUETOOTH / OPS CRITICAL WIRELESS ───────────────────────
  {
    ...
    items: [
      ...
      { desc: 'Operations Critical Wireless Earpiece with 12" Cable (without Charger)', part: 'NNTN8189', ear_type: null, mic_type: null, ptt: true, talk_time_hr: 10, charge_time_hr: 3, weight_g: 43 },
      { desc: 'Operations Critical Wireless Push-to-Talk Pod (with US Charger)', part: 'NNTN8127', ear_type: null, mic_type: null, ptt: true, talk_time_hr: 10, charge_time_hr: 3, weight_g: 43 },
      { desc: 'Operations Critical Wireless Push-to-Talk Pod (without Charger)', part: 'NNTN8191', ear_type: null, mic_type: null, ptt: true, talk_time_hr: 10, charge_time_hr: 3, weight_g: 43 },
      { desc: 'Bluetooth Accessory Kit with Flexible Earpiece, Pod and Charging Cradle (US Plug)', part: 'RLN6500', ear_type: 'Over-the-ear (swivel)', mic_type: 'In-line', ptt: false, talk_time_hr: 8, charge_time_hr: null, weight_g: null },
      { desc: 'Bluetooth Accessory Kit with Flexible Earpiece, Pod and Charging Cradle (ARG Plug)', part: 'RLN6502', ear_type: 'Over-the-ear (swivel)', mic_type: 'In-line', ptt: false, talk_time_hr: 8, charge_time_hr: null, weight_g: null },
      { desc: 'Bluetooth Accessory Kit with Flexible Earpiece, Pod and Charging Cradle (EURO Plug)', part: 'RLN6503', ear_type: 'Over-the-ear (swivel)', mic_type: 'In-line', ptt: false, talk_time_hr: 8, charge_time_hr: null, weight_g: null },
      { desc: 'Bluetooth Accessory Kit with Flexible Earpiece, Pod and Charging Cradle (BZL Plug)', part: 'RLN6504', ear_type: 'Over-the-ear (swivel)', mic_type: 'In-line', ptt: false, talk_time_hr: 8, charge_time_hr: null, weight_g: null },
      ...
      { desc: 'Operations Critical Wireless Earbud with 11.5" Cable', part: 'NNTN8294', ear_type: 'Earbud', mic_type: 'In-line', ptt: false, talk_time_hr: 10, charge_time_hr: null, weight_g: null },
      { desc: 'Operations Critical Wireless Earbud with 45" Cable', part: 'NNTN8295', ear_type: 'Earbud', mic_type: 'In-line', ptt: false, talk_time_hr: 10, charge_time_hr: null, weight_g: null }
    ]
  }
