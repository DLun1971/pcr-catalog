...
const XPR6000_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'IMPRES Single-Unit Charger, JAP Plug', part: 'PMPN4578A', impres: true, chem: 'Li-Ion, NiMH', pwr_src: '100-240 VAC', dims_mm: '51x88x94', pockets: 1, variants: ['6350','6550','6580'] },
      // Vehicular / travel
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Power Cord for IMPRES 2 Multi-Unit Charger, ARG Plug', part: '3087791G13', variants: ['6350','6550','6580'] },
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'IMPRES Windporting Public Safety Microphone with 3.5mm Audio Jack, Large (IP54), 30in Cable', part: 'PMMN4041', impres: true, intel_audio: false, ai_noise: 'Windporting', windporting: true, vol_ctrl: false, prog_btn: null, audio_jack: true, ip: 'IP54', hazloc: null, dims_mm: null, variants: ['6350','6550'] },
      { desc: 'IMPRES Windporting Public Safety Microphone with 3.5mm Audio Jack, Large (IP54), 24in Cable', part: 'PMMN4042', impres: true, intel_audio: false, ai_noise: 'Windporting', windporting: true, vol_ctrl: false, prog_btn: null, audio_jack: true, ip: 'IP54', hazloc: null, dims_mm: null, variants: ['6350','6550'] },
      { desc: 'IMPRES Windporting Public Safety Microphone with 3.5mm Audio Jack, Large (IP54), 18in Cable', part: 'PMMN4043', impres: true, intel_audio: false, ai_noise: 'Windporting', windporting: true, vol_ctrl: false, prog_btn: null, audio_jack: true, ip: 'IP54', hazloc: null, dims_mm: null, variants: ['6350','6550'] },
      { desc: 'IMPRES Windporting Public Safety Microphone, Large, Submersible (IP57), 30in Cable', part: 'PMMN4047', impres: true, intel_audio: false, ai_noise: 'Windporting', windporting: true, vol_ctrl: false, prog_btn: null, audio_jack: false, ip: 'IP57', hazloc: null, dims_mm: null, variants: ['6350','6550'] },
      { desc: 'IMPRES Windporting Public Safety Microphone, Large, Submersible (IP57), 24in Cable', part: 'PMMN4048', impres: true, intel_audio: false, ai_noise: 'Windporting', windporting: true, vol_ctrl: false, prog_btn: null, audio_jack: false, ip: 'IP57', hazloc: null, dims_mm: null, variants: ['6350','6550'] },
      { desc: 'IMPRES Windporting Public Safety Microphone, Large, Submersible (IP57), 18in Cable', part: 'PMMN4049', impres: true, intel_audio: false, ai_noise: 'Windporting', windporting: true, vol_ctrl: false, prog_btn: null, audio_jack: false, ip: 'IP57', hazloc: null, dims_mm: null, variants: ['6350','6550'] },
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Receive-Only Covered Earbud with Coiled Cord', part: 'AARLN4885', ear_type: 'Foam covered earbud', hazloc: 'UL', variants: ['6350','6550','6580'] },
      { desc: 'Receive-Only Earpiece with Translucent Tube and Rubber Eartip', part: 'RLN4941', ear_type: 'Clear rubber eartip', hazloc: 'UL', variants: ['6350','6550','6580'] },
      { desc: 'Receive-Only Earpiece with Translucent Tube and Rubber Eartip', part: 'PMLN7560', ear_type: 'Clear rubber eartip', variants: ['6350','6550','6580'] },
      { desc: 'Receive-Only Flexible Earpiece', part: 'WADN4190', ear_type: 'Over-the-ear', hazloc: 'UL', variants: ['6350','6550','6580'] },
      { desc: 'Receive-Only D-Shell Earpiece', part: 'PMLN4620', ear_type: 'Over-the-ear', hazloc: 'UL', variants: ['6350','6550','6580'] },
      { desc: 'D-Shell Adjustable Earpiece', part: 'PMLN7396', ear_type: 'Over-the-ear', variants: ['6350','6550','6580'] },
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Heavy Duty Headset with Over-the-Head Headband and Boom Mic (ATEX)', part: 'PMLN6087', headset_type: 'Over-the-head', ear_style: 'Dual-muff', nrr_db: null, mic_type: 'Boom', hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'Heavy Duty Headset with Helmet Attachment and Boom Mic (ATEX)', part: 'PMLN6092', headset_type: 'Helmet attach', ear_style: 'Dual-muff', nrr_db: null, mic_type: 'Boom', hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'Twin Cup Heavy Duty Headset with Helmet Attachment and Boom Mic, Extra High-Attenuating (ATEX)', part: 'PMLN6333', headset_type: 'Helmet attach', ear_style: 'Dual-muff', nrr_db: null, mic_type: 'Boom', hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'Tactical Heavy Duty Headset with Helmet Attachment, Boom Mic and Volume Control (ATEX)', part: 'PMLN6089', headset_type: 'Helmet attach', ear_style: 'Dual-muff', nrr_db: null, mic_type: 'Boom', hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'Tactical Heavy Duty Headset with Neckband, Boom Mic and Volume Control (ATEX)', part: 'PMLN7535', headset_type: 'Over-the-head', ear_style: 'Dual-muff', nrr_db: null, mic_type: 'Boom', hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'HC-1 Helmet-COM Bone Conduction Mic with Single Speaker (ATEX)', part: 'RMN5123', headset_type: 'Helmet attach', ear_style: 'Dual-muff', nrr_db: null, mic_type: 'Bone conduction', hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'HC-2 Helmet-COM Bone Conduction Mic with Dual Speaker (ATEX)', part: 'GMMN4580', headset_type: 'Helmet attach', ear_style: 'Dual-muff', nrr_db: null, mic_type: 'Bone conduction', hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'ATEX Push-to-Talk Adapter (must be ordered with any Heavy Duty Headset)', part: 'PMLN6368', headset_type: null, ear_style: null, nrr_db: null, mic_type: null, hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      { desc: 'ATEX Small Push-to-Talk Adapter', part: 'PMLN6803', headset_type: null, ear_style: null, nrr_db: null, mic_type: null, hazloc: 'ATEX', variants: ['6350','6550','6580'] },
      // 3M Peltor
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Soft Leather Case with 2.5in Swivel Belt Loop (Display)', part: 'PMLN5016', material: 'Soft leather', belt_sz: 2.5, swivel: true, display: true, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Soft Leather Case with 3in Swivel Belt Loop (Display)', part: 'PMLN5017', material: 'Soft leather', belt_sz: 3, swivel: true, display: true, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Soft Leather Case with 3in Fixed Belt Loop (Display)', part: 'PMLN5018', material: 'Soft leather', belt_sz: 3, swivel: false, display: true, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Hard Leather Case with 2.5in Swivel Belt Loop (Display)', part: 'PMLN5019', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: true, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Hard Leather Case with 3in Swivel Belt Loop (Display)', part: 'PMLN5020', material: 'Hard leather', belt_sz: 3, swivel: true, display: true, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Hard Leather Case with 3in Fixed Belt Loop (Display)', part: 'PMLN5021', material: 'Hard leather', belt_sz: 3, swivel: false, display: true, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Nylon Case with 3in Fixed Belt Loop (Display)', part: 'PMLN5015', material: 'Nylon', belt_sz: 3, swivel: false, display: true, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Soft Leather Case with 2.5in Swivel Belt Loop (Non-Display)', part: 'PMLN5025', material: 'Soft leather', belt_sz: 2.5, swivel: true, display: false, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Soft Leather Case with 3in Swivel Belt Loop (Non-Display)', part: 'PMLN5026', material: 'Soft leather', belt_sz: 3, swivel: true, display: false, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Soft Leather Case with 3in Fixed Belt Loop (Non-Display)', part: 'PMLN5027', material: 'Soft leather', belt_sz: 3, swivel: false, display: false, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Hard Leather Case with 2.5in Swivel Belt Loop (Non-Display)', part: 'PMLN5028', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: false, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Hard Leather Case with 3in Swivel Belt Loop (Non-Display)', part: 'PMLN5029', material: 'Hard leather', belt_sz: 3, swivel: true, display: false, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Hard Leather Case with 3in Fixed Belt Loop (Non-Display)', part: 'PMLN5030', material: 'Hard leather', belt_sz: 3, swivel: false, display: false, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Nylon Case with 3in Fixed Belt Loop (Non-Display)', part: 'PMLN5024', material: 'Nylon', belt_sz: 3, swivel: false, display: false, d_rings: true, variants: ['6350','6550','6580'] },
      { desc: 'Spring Action 2in Belt Clip', part: 'PMLN4651', material: 'Plastic', belt_sz: 2, swivel: false, display: null, d_rings: false, variants: ['6350','6550','6580'] },
      { desc: 'Spring Action 2.5in Belt Clip', part: 'PMLN7008', material: 'Plastic', belt_sz: 2.5, swivel: false, display: null, d_rings: false, variants: ['6350','6550','6580'] },
      { desc: 'Replacement 2.5in Swivel Belt Loop', part: 'PMLN5610', material: 'Hard leather', belt_sz: 2.5, swivel: true, display: null, d_rings: false, variants: ['6350','6550','6580'] },
      { desc: 'Replacement 3in Leather Swivel Belt Loop', part: 'PMLN5611', material: 'Hard leather', belt_sz: 3, swivel: true, display: null, d_rings: false, variants: ['6350','6550','6580'] },
      { desc: 'Nylon Wrist Strap', part: 'PMLN6074', material: 'Nylon', belt_sz: null, swivel: null, display: null, d_rings: false, variants: ['6350','6550','6580'] },
      { desc: 'Accessory Connector Dust Cover', part: '15012157001', material: 'Plastic', belt_sz: null, swivel: null, display: null, d_rings: false, variants: ['6350','6550','6580'] },
      { desc: 'Accessory Connector Dust Cover', part: '1571477L01', material: 'Plastic', belt_sz: null, swivel: null, display: null, d_rings: false, variants: ['6350','6550','6580'] },
      { desc: 'Accessory Connector Dust Cover', part: 'PMLN6066', material: 'Plastic', belt_sz: null, swivel: null, display: null, d_rings: false, variants: ['6350','6550','6580'] },
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Whip 350-400 MHz + GPS Folded Monopole Antenna, 16.5cm', part: 'PMAD4112', band: 'VHF', freq_mhz: '350-400', len_cm: 16.5, ant_type: 'Whip', variants: ['6350','6550','6580'] },
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Operations Critical Wireless Earpiece with 12-Inch Cable (with US/JP Charger)', part: 'NNTN8125', ear_type: 'Over-the-ear (CommPort)', mic_type: 'Directional', ptt: true, talk_time_hr: 10, charge_time_hr: 3, weight_g: 43, variants: ['6350','6550','6580'] },
      { desc: 'Operations Critical Wireless Earpiece with 12-Inch Cable (without Charger)', part: 'NNTN8189', ear_type: null, mic_type: null, ptt: true, talk_time_hr: 10, charge_time_hr: 3, weight_g: 43, variants: ['6350','6550','6580'] },
      { desc: 'Enhanced Operations Critical Wireless Earpiece with 12-Inch Cable and PTT Pod', part: 'NTN2570', ear_type: 'Over-the-ear (CommPort)', mic_type: 'Directional', ptt: true, talk_time_hr: 10, charge_time_hr: 3, weight_g: 43, variants: ['6350','6550','6580'] },
      { desc: 'Swivel Earpiece with In-Line Microphone Multi-Pack (3-pack) for MOTOTRBO Bluetooth Accessory Kit', part: 'RLN6550', ear_type: 'Over-the-ear (swivel)', mic_type: 'Boom', ptt: null, talk_time_hr: null, charge_time_hr: null, weight_g: null, variants: ['6350','6550','6580'] },
      { desc: 'Flexible Fit Swivel Earpiece with Boom Microphone Multi-Pack (3-pack) for MOTOTRBO Bluetooth Accessory Kit', part: 'PMLN7203', ear_type: 'Over-the-ear (swivel)', mic_type: 'Boom', ptt: null, talk_time_hr: null, charge_time_hr: null, weight_g: null, variants: ['6350','6550','6580'] },
