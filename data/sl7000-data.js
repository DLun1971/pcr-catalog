...
const SL7000_CATEGORIES = [
  {
    ...
    name: 'Batteries',
    items: [
      { desc: 'Motorola Original Li-Ion 1700mAh IP68 Battery', part: 'PMNN4440', impres: false, chem: 'Li-Ion', capacity_mah: 1700, dims_mm: '96x56x15', weight_g: 110, hazloc: null, ip: 'IP68', op_temp: '-10°C to +60°C' },
      { desc: 'IMPRES Li-Ion 3000mAh IP68 Battery', part: 'PMNN4502', impres: true, chem: 'Li-Ion', capacity_mah: 3000, dims_mm: '96x56x23', weight_g: 155, hazloc: null, ip: 'IP68', op_temp: '-10°C to +60°C' },
      { desc: 'IMPRES Li-Ion 2900mAh IP68 Battery', part: 'PMNN4511', impres: true, chem: 'Li-Ion', capacity_mah: 2900, dims_mm: '96x56x23', weight_g: 155, hazloc: 'UL', ip: 'IP68', op_temp: '-20°C to +60°C' },
      ...
      { desc: 'Replacement Battery Cover for PMNN4468', part: 'PMLN7074', impres: false, chem: null, capacity_mah: null, dims_mm: null, weight_g: null, hazloc: null, ip: null, op_temp: null }
    ]
  },
  {
    id: 2,
    ...
    items: [
      ...
      { desc: 'Tri-Unit Rapid Rate Charger, ARG Plug', part: 'PMLN6702', impres: false, chem: 'Li-Ion', pwr_src: '220 VAC', dims_mm: '52x93x113', pockets: 3 },
      { desc: 'Tri-Unit Rapid Rate Charger, KOR Plug', part: 'PMLN6699', impres: false, chem: 'Li-Ion', pwr_src: '110-230 VAC', dims_mm: '52x93x113', pockets: 3 }
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Low Noise Kit with Translucent Tube and 1 Clear Rubber Eartip', part: 'RLN6242', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Clear rubber eartip', mic_type: null, full_duplex: false, hazloc: null },
      ...
      { desc: 'Replacement Quick Disconnect Translucent Tube with Clear Rubber Eartip', part: 'HKLN4608', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Clear rubber eartip', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Replacement Standard Clear Rubber Eartip, Pack of 50', part: 'RLN6282', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Clear rubber eartip', mic_type: null, full_duplex: false, hazloc: null },
      ...
      { desc: 'Small Custom Earpiece, Right Ear', part: 'RLN4760', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Custom earpiece', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Medium Custom Earpiece, Right Ear', part: 'RLN4761', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Custom earpiece', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Large Custom Earpiece, Right Ear', part: 'RLN4762', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Custom earpiece', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Small Custom Earpiece, Left Ear', part: 'RLN4763', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Custom earpiece', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Medium Custom Earpiece, Left Ear', part: 'RLN4764', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Custom earpiece', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Large Custom Earpiece, Left Ear', part: 'RLN4765', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Custom earpiece', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Clear EP7-Small Hearing Protectors [Sonic Defenders] Ultra Earplugs, NR 28dB', part: 'RLN6511', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Comply foam eartip', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Clear EP7-Medium Hearing Protectors [Sonic Defenders] Ultra Earplugs, NR 28dB', part: 'RLN6512', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Comply foam eartip', mic_type: null, full_duplex: false, hazloc: null },
      { desc: 'Clear EP7-Large Hearing Protectors [Sonic Defenders] Ultra Earplugs, NR 28dB', part: 'RLN6513', impres: false, intel_audio: false, ai_noise: false, ear_type: 'Comply foam eartip', mic_type: null, full_duplex: false, hazloc: null }
    ]
  },
  {
    id: 5,
  ...
  },
  {
    ...
    name: 'Carry',
    items: [
      { desc: 'Carry Holder/Holster for SL Series Radio with Swivel Belt Loop', part: 'PMLN5956', material: 'Plastic', belt_sz: null, swivel: 'Swivel', display: 'Display', d_rings: false },
  ...
  },
  {
    ...
    items: [
      ...
      { desc: 'Screen Protector, Clear, Single Pack', part: 'AY000267A01' }
    ]
  },
  {
    id: 10,
  ...
  },
  {
    ...
    items: [
      { desc: 'Operations Critical Wireless RSM with Battery and Belt Clip', part: 'RLN6561', ear_type: null, mic_type: 'Omni directional, windporting equivalent', ptt: true, talk_time_hr: 28, charge_time_hr: 3, weight_g: 158 },
      { desc: 'Operations Critical Wireless RSM with Battery, Belt Clip and Dual Unit Charger (US Plug)', part: 'RLN6562', ear_type: null, mic_type: 'Omni directional, windporting equivalent', ptt: true, talk_time_hr: 28, charge_time_hr: 3, weight_g: 158 },
      { desc: 'Operations Critical Wireless RSM with Battery, Belt Clip and Dual Unit Charger (AU/NZ Plug)', part: 'PMLN7669', ear_type: null, mic_type: 'Omni directional, windporting equivalent', ptt: true, talk_time_hr: 28, charge_time_hr: 3, weight_g: 158 },
      ...
      { desc: 'Replacement Micro-USB Plug-In Charger for Wireless Pod, KOR Plug', part: 'PMPN4015', ear_type: null, mic_type: null, ptt: null, talk_time_hr: null, charge_time_hr: null, weight_g: null },
      ...
      { desc: 'Replacement Micro-USB Plug-In Charger for Wireless Pod, BZL Plug', part: 'PMPN4023', ear_type: null, mic_type: null, ptt: null, talk_time_hr: null, charge_time_hr: null, weight_g: null },
